    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-6">
                    <button class="col-md-12 btn btn-default">Пополнить баланс</button>
                </div>
                <div class="col-md-6">
                    <button class="col-md-12 btn btn-default">Внутренний перевод</button>
                </div>
                ...
                <div class="col-md-12">
                    <table>
                        ...
                        <tr data-toggle="collapse" data-target="#level1" class="clickable" style="border-top: 1px solid #f2dede;height: 100px;">
                        ...
                        <tr data-toggle="collapse" data-target="#level2" class="clickable" style="border-top: 1px solid #f2dede;height: 100px;">
                            <td class="col-md-1">13 ноя</td>
                            <td class="col-md-1">icon</td>
                            <td class="col-md-9">пополнение баланса<br>
                                В обработке
            ...
            <div class="col-md-3 pull-right" style="border: 1px solid black; margin-top: 42px;">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="{{ route('balance') }}">....Баланс</a></li>
